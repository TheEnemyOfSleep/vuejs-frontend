...
const PostCreate = { template: '<div>This is post create body</div>' }
const UsersCreate = { template: '<div>This is Users create body</div>' }
...
let vm = new Vue({
  ...
  mounted() {
    axios
      .get('https://djangotests.theenemyofsleep.repl.co/api/v1/blog/posts/')
      .then(response => {
